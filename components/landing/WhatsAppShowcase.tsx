          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto lg:mx-0">
              <div className="bg-white rounded-2xl p-4 shadow-lg border border-gray-100">
                ...
                <div className="text-sm text-gray-600">אחוז פתיחה</div>
              </div>
              <div className="bg-white rounded-2xl p-4 shadow-lg border border-gray-100">
                <div className="text-3xl font-bold text-primary">2 שניות</div>
                <div className="text-sm text-gray-600">זמן משלוח</div>
              </div>
            </div>
          </motion.div>
