    ...
    <>
      ...
      >
        ...
        <Step>
          <div className="space-y-6">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900">בחירת חבילה</h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-center">
                      {/* Guest Count */}
                      <div className="mb-2">
                        <span className="text-4xl font-bold text-gray-900">{pkg.guests}</span>
                        <span className="text-gray-500 mr-1">מוזמנים</span>
                      </div>
                      ...
                      <p className="text-sm text-gray-500 mt-2">
                        {isFree ? 'מושלם להתחלה' : `עד ${pkg.guests} אורחים במערכת`}
                      </p>
                    </div>
                  </motion.div>
                );
            ...
            <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-blue-800 font-medium">מה כוללת החבילה?</p>
            ...
            <div className="space-y-6">
              ...
              {paymentLoading && (
                <div className="flex flex-col items-center justify-center py-16 bg-gray-50 rounded-2xl">
                  ...
                  />
                  <p className="mt-4 text-gray-600 font-medium">טוען טופס תשלום מאובטח...</p>
              ...
              {paymentClearingUrl && !paymentLoading && (
                <motion.div
                  ...
                  className="rounded-2xl overflow-hidden shadow-xl border-2 border-gray-100"
                >
            ...
            >
              ...
              <div className="bg-gradient-to-br from-green-400 to-emerald-500 p-8 text-center">
                <motion.div
                  ...
                  className="w-24 h-24 mx-auto bg-white rounded-full flex items-center justify-center shadow-lg"
                >
                  <motion.svg
              ...
              <div className="p-8 text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">התשלום בוצע בהצלחה!</h2>
